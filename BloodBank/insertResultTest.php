...
if (isset($_POST['save'])) {
       ...
       $text = " نعتذر منك $name لن يتم حفظ بياناتك لان فحوصاتك غير سليمة .";
       $coding = "2";
     ...
     //  echo "<meta http-equiv='refresh' content='1;url=http://52.36.50.145:8080/MainServlet?$data'>";
    }
    else {
       $statue = 1;
    }
    ...
    if ( $statue == 1)
    {
       ...
       $password = "Blood@255";
       $mobileNo = $_POST['Phone'];
       $text = " $name تم حفظ بياناتك وسيتم ارسال رسالة نصية لك عند احتياج اي شخص للتبرع .";
       $coding = "2";
       $text = urlencode($text);
       $data = "orgName=".$orgName . "&userName=".$userName."&password=".$password."&mobileNo=".$mobileNo."&text=".$text."&coding=".$coding;
       $url="http://52.36.50.145:8080/MainServlet?".$data;
