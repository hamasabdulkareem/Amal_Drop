        ...
        <form method="post" action="show_dataOfDonor.php">
          <br>
           <section >
            ...
            <br>
     <a href="edit_dataOfDonor.php?id=<?php echo $row['Donor_ID']; ?> && lang=en"><?php echo $lang['Modify']?></a>
     <a href="activity.php?id=<?php echo $row['Donor_ID']; ?> && lang=en"><?php echo $lang['act']?></a>
        </form>
    </div>
</section>
       <?php  }
