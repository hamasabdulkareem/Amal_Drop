...
$output = ' ';
    ...
    if (isset($_POST['search']))
    {
       ...
       $go = "<meta http-equiv='refresh' content='3;url=insertResultTest.php?id=$id && lang=ar'>";
       echo $go;
       }
        ...
        <form method="post" action="search.php"><br>
              ...
              <!----><input type="hidden" name="BloodBank_Name" value="<?php echo $row['BloodBank_Name']; ?>">
               ...
               ?>
                ...
                <input type="text" name="Donor_Phone" placeholder="<?php echo $lang['Donor_Ph']?>" required><br>
