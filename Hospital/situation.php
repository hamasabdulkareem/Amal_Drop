        ...
        <form method="post" action="situation.php">
                   ...
                   ?>
                    ...
                    <input type="hidden" value="<?php echo $row['Activity_ID'];?>" name="id">
                       ...
                       <td> <a href="done.php?id=<?php echo $row['Activity_ID']; ?> && idDonor=<?php echo $row['Donor_ID']; ?>"><?php echo $lang["Done"]?></a> </td>
                        <td>
               ...
               <?php
                    ...
                    ?>
                <tr>
                    <td colspan="5" style="text-align: center; color: #f00"><?php echo $row['Datanotfound']; ?></td>
                </tr>
                   <?php
                  }
            ?>
...
-->
  <!--<td><?php echo $row['Activity_ID']; ?> <input type="hidden" value="<?php echo $row['Activity_ID']; ?>" name="id"> </td> <input type="hidden" value="<?php echo $row['Donor_ID']; ?>" name="idDonor"></td>--> 
